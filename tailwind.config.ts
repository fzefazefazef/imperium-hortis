	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				'riviera-blue': 'hsl(var(--riviera-blue))',
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': { 
						boxShadow: '0 0 20px hsl(var(--sage-green) / 0.3)' 
					},
					'50%': { 
						boxShadow: '0 0 40px hsl(var(--sage-green) / 0.6)' 
					}
				}
			},
			animation: {
				...
				'fade-in-slow': 'fade-in-slow 1.2s cubic-bezier(0.16, 1, 0.3, 1)',
