  ...
  return (
    <section className="relative h-screen flex items-start justify-start overflow-hidden bg-gradient-to-br from-deep-charcoal via-midnight-blue to-deep-charcoal">
        ...
        <div className="flex space-x-8">
          {[
            ...
            <Link
              key={item.name}
              to={item.path}
              className="font-italiana text-sm font-medium text-white hover:text-whisper-gold transition-all duration-300 hover:scale-105 tracking-wider"
              style={{ 
      ...
      <div className="absolute left-0 top-[40%] z-20 pl-4 md:pl-6 lg:pl-8 max-w-2xl animate-fade-in-slow">
        <h1 className="font-italiana text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
          Imperium
