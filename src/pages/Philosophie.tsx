    ...
    <Layout navTheme="default">
      <div className="min-h-screen bg-gradient-to-br from-deep-charcoal via-midnight-blue to-deep-charcoal text-foreground pt-32 sm:pt-32 px-8 md:px-16 lg:px-24">
        <div className="max-w-6xl mx-auto">
          <h1 className="font-cinzel text-4xl md:text-6xl font-bold text-soft-white mb-12 text-center lg:!text-black">
            <span className="lg:!text-black">{t('philosophy.title').split(' ')[0]}</span> <span className="text-sage-green lg:!text-black">{t('philosophy.title').split(' ').slice(1).join(' ')}</span>
          </h1>
