    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in">
              <h2 className="font-italiana text-3xl md:text-4xl lg:text-5xl font-semibold text-soft-white mb-8">
                {t('about.title')}
              </h2>
      ...
      <section className="py-24 px-8 md:px-16 lg:px-24 bg-midnight-blue/50">
        <div className="max-w-6xl mx-auto">
          <h2 
            ref={titleRef}
            className={`font-italiana text-3xl md:text-4xl lg:text-5xl font-semibold text-soft-white text-center mb-16 transition-all duration-1000 ${
              titleVisible 
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="font-italiana text-xl font-semibold text-soft-white mb-4 group-hover:text-whisper-gold transition-colors duration-300">
                  {service.title}
                </h3>
          ...
          >
            ...
            >
              <Button 
                variant="minimal" 
                size="xl" 
                className={`font-inter font-medium transform transition-all duration-500 relative overflow-hidden ${
      ...
      <footer className="py-20 px-8 md:px-16 lg:px-24 bg-gradient-to-t from-deep-charcoal via-midnight-blue/30 to-deep-charcoal border-t border-whisper-gold/40">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h3 className="font-italiana text-4xl font-bold text-soft-white mb-4 tracking-widest uppercase">
              IMPERIUM HORTIS
            </h3>
            ...
            <p className="font-italiana text-xl text-soft-graphite max-w-2xl mx-auto leading-relaxed italic tracking-wider">
          ...
          <div className="bg-gradient-to-r from-whisper-gold/5 via-whisper-gold/8 to-whisper-gold/5 backdrop-blur-sm border border-whisper-gold/20 p-10 mb-16 relative">
            ...
            <h4 className="font-italiana text-2xl font-semibold text-whisper-gold mb-8 text-center tracking-wide">
              Contact
            </h4>
